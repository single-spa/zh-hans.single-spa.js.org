...
- [single-spa-html with js example](https://github.com/filoxo/single-spa-html-with-js-example): 是一个使用纯JavaScript增强的single-spa-html示例仓库.
- [coexisting-angular-microfrontends/login](https://github.com/Vallerious/coexisting-angular-microfrontends/tree/feature/login) 是一个实现Angular应用程序之间登录功能的分支。它使用localStorage作为共享内存空间来存储和检索token.
- [single-spa-angular-cli](https://github.com/matt-gold/single-spa-angular-cli) 是一个 all-Angular 示例仓库，使用SystemJS将single-spa-angular应用程序加载到包含不同路由的Angular CLI应用程序中.
